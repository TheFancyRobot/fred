...
- BAML and Convex adapter testing subpath exports prefer source files for Bun local `file:` dependency consumption while retaining built JavaScript fallbacks
