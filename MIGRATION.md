...
| --- | --- | --- | --- |
| `@fancyrobot/fred` | `2.2.0` | `effect ^3.21.5`, `@effect/ai ^0.35.0`, `@effect/platform ^0.96.0` | Core `createFred()` client and Effect services |
...
| `@fancyrobot/fred-openai` | `4.2.0` | Fred `^2.0.0`; `effect ^3.21.5`; `@effect/ai ^0.35.0`; `@effect/ai-openai ^0.39.0`; `@effect/ai-openrouter ^0.10.0`; `@effect/platform ^0.96.0` | OpenAI provider |
