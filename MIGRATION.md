...
| `@fancyrobot/fred-cli` | `0.6.0-alpha.1` | Fred `^2.0.0-alpha.0`; `effect ^3.21.5` | CLI, TUI, development chat, and API-key commands |
...
| `@fancyrobot/fred-baml` | `1.0.0-alpha.1` | Fred `^2.0.0-alpha.0`; `effect ^3.21.5` | Consumer-owned BAML tools and prompt adapter |
| `@fancyrobot/fred-convex` | `1.0.0-alpha.1` | Fred `^2.0.0-alpha.0`; `convex ^1.42.1`; `effect ^3.21.5` | Convex runtime and tool adapters |
| `@fancyrobot/fred-anthropic` | `4.0.0-alpha.1` | Fred `^2.0.0-alpha.0`; `effect ^3.21.5`; `@effect/ai ^0.35.0`; `@effect/ai-anthropic ^0.25.0` | Anthropic provider |
...
| `@fancyrobot/fred-openai` | `4.0.0-alpha.1` | Fred `^2.0.0-alpha.0`; `effect ^3.21.5`; `@effect/ai ^0.35.0`; `@effect/ai-openai ^0.39.0` | OpenAI provider |
| `@fancyrobot/fred-openrouter` | `5.0.0-alpha.1` | Fred `^2.0.0-alpha.0`; `effect ^3.21.5`; `@effect/ai ^0.35.0`; `@effect/ai-openrouter ^0.10.0` | OpenRouter provider |
...
they differ from this checkout. See the
