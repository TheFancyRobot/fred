# Migration Guide: v0.1.0 - Effect Services

This guide helps you migrate to Fred v0.1.0, which introduces Effect-based services internally while maintaining backwards-compatible Promise APIs.
