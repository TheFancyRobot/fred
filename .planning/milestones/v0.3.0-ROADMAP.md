# Milestone v0.2.0: Observability & Safety
...
Fred v0.2.0 delivered production-focused observability, deterministic evaluation and replay, intent-aware tool safety controls, MCP multi-server integration, and routing explainability APIs. The milestone completed all 35 mapped requirements across phases 22-26.
...
**Issues Deferred:**
- API documentation for newly shipped v0.2.0 interfaces remains pending.
- Existing pre-v0.2.0 failing service-layer isolation tests remain outside milestone scope.
