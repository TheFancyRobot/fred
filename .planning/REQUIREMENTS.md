...
- [ ] **VISUAL-12**: Assistant messages render with muted styling distinct from user messages
- [ ] **VISUAL-13**: Tool calls and task results render as inline expandable blocks with `└` tree connectors
- [ ] **VISUAL-14**: Active/streaming content uses a distinct accent color (e.g. orange/amber) to indicate liveness
...
| VISUAL-12 | Phase 39 | Pending |
| VISUAL-13 | Phase 39 | Pending |
| VISUAL-14 | Phase 39 | Pending |
