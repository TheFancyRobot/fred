...
export interface MiniMaxVideoAdapter {
  ...
  readonly createTask: (input: VideoGenerationInput) => Effect.Effect<VideoTaskResult, MiniMaxVideoError, HttpClient.HttpClient>;
  readonly queryTask: (input: VideoQueryInput) => Effect.Effect<VideoQueryResult, MiniMaxVideoError, HttpClient.HttpClient>;
}
